...
export const systemService = {
    async getSystem(app, query) {
        const { page = 1, limit = 10, q, systemType, systemCode, sortBy = "CREATED_DT", order = "desc", } = query;
    ...
    async updateSystem(app, data) {
        ...
        try {
            ...
            if (e instanceof Prisma.PrismaClientKnownRequestError) {
                if (e.code === "P2025") {
                    app.log.error(`Record not found with key: ${SYSTEM_TYPE}, ${SYSTEM_CD}, ${VALID_FROM_DT}`);
