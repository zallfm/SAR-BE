...
export const authService = {
    async login(app, username, password, requestId) {
        ...
        if (isLocked(username)) {
            ...
            throw new ApplicationError(ERROR_CODES.AUTH_ACCOUNT_LOCKED, ERROR_MESSAGES[ERROR_CODES.AUTH_ACCOUNT_LOCKED], {
                locked: true,
        ...
        if (!valid) {
            ...
            throw new ApplicationError(ERROR_CODES.AUTH_INVALID_CREDENTIALS, message, {
                locked: false,
