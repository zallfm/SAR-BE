...
import { listUarSchema, getUarDetailsSchema, batchUpdateSchema, exportUarExcelSchema, getUarSchema, } from "../../modules/uar_division/uar_division.schema";
export async function uarDivisionRoutes(app) {
    ...
    app.get("/excel/:id", { schema: getUarSchema }, uarDivisionController.getUar(app));
    app.post("/batch-update", { schema: batchUpdateSchema }, uarDivisionController.batchUpdate(app));
    app.get("/export", { schema: exportUarExcelSchema }, uarDivisionController.exportExcel(app));
}
