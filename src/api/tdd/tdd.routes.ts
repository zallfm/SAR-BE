...
import {
  ...
  getModuleEvidence,
  getAllEvidence,
  exportEvidenceToExcel
} from './tdd-evidence.controller.js';

const __filename = fileURLToPath(import.meta.url);
const __dirname = path.dirname(__filename);

export async function tddRoutes(app: FastifyInstance) {
  ...
  app.get('/tdd/api/evidence/:module/:function', async (request, reply) => {
    const { module, function: functionName } = request.params as { module: string; function: string };
